...
* form := list | atom
* list := '\(' form '\)'
* atom := ignored | doubleQuoted | comment | '[^\s\[\]{}(\'"`,;)]*'
* // tokens
* ignored := '[\s,]*'
* doubleQuoted := '"(?:\\.|[^\\"])*"?'
* comment := ';.*'
...
export type form_1 = list;
export type form_2 = atom;
export interface list {
    kind: ASTKinds.list;
}
export type atom = atom_1 | atom_2 | atom_3 | atom_4;
export type atom_1 = ignored;
export type atom_2 = doubleQuoted;
export type atom_3 = comment;
export type atom_4 = string;
export type ignored = string;
export type doubleQuoted = string;
...
export class Parser {
    ...
    public matchform($$dpth: number, $$cr?: ErrorTracker): Nullable<form> {
        return this.choice<form>([
            () => this.matchform_1($$dpth + 1, $$cr),
            () => this.matchform_2($$dpth + 1, $$cr),
        ]);
    }
    public matchform_1($$dpth: number, $$cr?: ErrorTracker): Nullable<form_1> {
        return this.matchlist($$dpth + 1, $$cr);
    }
    public matchform_2($$dpth: number, $$cr?: ErrorTracker): Nullable<form_2> {
        ...
        return this.run<list>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && this.matchform($$dpth + 1, $$cr) !== null
                    && this.regexAccept(String.raw`(?:\))`, $$dpth + 1, $$cr) !== null
                ) {
                    $$res = {kind: ASTKinds.list, };
                }
                return $$res;
            });
    }
    ...
    public matchatom_1($$dpth: number, $$cr?: ErrorTracker): Nullable<atom_1> {
        return this.matchignored($$dpth + 1, $$cr);
    }
    public matchatom_2($$dpth: number, $$cr?: ErrorTracker): Nullable<atom_2> {
        return this.matchdoubleQuoted($$dpth + 1, $$cr);
    }
    ...
    public matchignored($$dpth: number, $$cr?: ErrorTracker): Nullable<ignored> {
        return this.regexAccept(String.raw`(?:[\s,]*)`, $$dpth + 1, $$cr);
    }
    public matchdoubleQuoted($$dpth: number, $$cr?: ErrorTracker): Nullable<doubleQuoted> {
